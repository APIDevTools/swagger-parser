...
var debug="localhost"===location.hostname;exports.init=function(){debug||(ga("create","UA-68102273-1","auto"),ga("send","pageview"))},exports.trackEvent=function(e,o,n,t){debug?console.log("Reporting an event to Google Analytics: ",e,o,n,t):ga("send","event",e,o,n,t)},exports.trackError=function(e){debug?console.error("Reporting an error to Google Analytics: ",e):ga("send","exception",{exDescription:e.message})};
...
function parseSwagger(){try{editors.clearResults(),parser=parser||new SwaggerParser;var r=form.getOptions(),e=form.method.button.val(),t=form.getAPI();parser[e](t,r).then(function(){var r=parser.$refs.values();Object.keys(r).forEach(function(e){editors.showResult(e,r[e])})})["catch"](function(r){editors.showError(ono(r)),analytics.trackError(r)}),counters[e]++,analytics.trackEvent("button","click",e,counters[e])}catch(o){editors.showError(ono(o)),analytics.trackError(o)}}var form=require("./form"),editors=require("./editors"),analytics=require("./analytics"),ono=require("ono"),parser=null,counters={parse:0,resolve:0,bundle:0,dereference:0,validate:0};exports.init=function(){form.form.on("submit",function(r){r.preventDefault(),parseSwagger()}),$("#clear").on("click",function(){parser=null,editors.clearResults(),analytics.trackEvent("cache","clear")})};
