(function () {
...
})()(
  {
    ...
    206: [
      function (require, module, exports) {
        "use strict";
        let debug = "localhost" === location.hostname;
        function analytics() {
    ...
    207: [
      function (require, module, exports) {
        ...
        function setRefsLabel() {
          let e = getCheckedAndUnchecked(form.refs.external, form.refs.circular);
          switch (e.checked.length) {
            case 0:
        ...
        function setValidateLabel() {
          let e = getCheckedAndUnchecked(form.validate.schema, form.validate.spec);
          switch (e.checked.length) {
            case 0:
        ...
        function trackCheckbox(e) {
          e.on("change", () => {
            let t = e.is(":checked") ? 1 : 0;
            analytics.trackEvent("options", "changed", e.attr("name"), t);
          });
        }
        function trackButtonLabel(e) {
          let t = ["", "parse", "resolve", "bundle", "dereference", "validate"].indexOf(e);
      ...
      function (require, module, exports) {
        ...
        (module.exports = editors),
          ...
          (editors.addResult = function (e, t) {
            let s = editors.tabs.children().length,
            ...
            let n = getShortTitle(e) || "Sample API";
            editors.tabs
              .find("#" + r)
              .text(n)
              .attr("title", e),
      ...
      function (require, module, exports) {
        ...
        function parseSwagger() {
          try {
            ...
            let r = form.getOptions(),
              e = form.method.button.val(),
              s = form.getAPI();
            swaggerParser[e](s, r)
              .then(() => {
                let r = swaggerParser.$refs.values();
    ...
    212: [
      function (require, module, exports) {
        ...
        function setFormFields() {
          let e = qs.parse(window.location.search.substr(1));
        ...
        function setBookmarkURL() {
          ...
          let r = form.method.button.val();
          "validate" === r || (e.method = r);
          let t = form.url.val();
          "" === t || (e.url = t);
          let l = "?" + qs.stringify(e);
