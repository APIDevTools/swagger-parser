...
Added a new [`$refs.circular` option](https://github.com/APIDevTools/swagger-parser/blob/master/docs/options.md) to determine how circular references are handled. SwaggerParserOptions are fully-dereferencing them (default), throwing an error, or ignoring them.
